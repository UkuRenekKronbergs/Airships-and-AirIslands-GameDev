...
## 🎮 Game Summary
_Airships and AirIslands_ is a roguelike-inspired strategy game where the player commands a flying fortress — a ship that is both home and weapon.  
The game blends **FTL-style node exploration** with **Fallout Shelter–like building mechanics**, while adding crew needs, trade, and survival elements.  

Key inspirations: **FTL**, **Fallout Shelter**, **Sunless Sea**, **Oxygen Not Included**, **Rimworld**.
...
Focus: **core systems, MVP features, and replayable loop**.  

---

## 🔗 Important Links
- 📄 [Full Design Document (Google Docs)](https://docs.google.com/document/d/1i99bId0QjzpgUB3H5IsGsH8DRXBDhwpya8sREnU-xZM/edit?usp=sharing)  
- 🎥 [Project Setup Video (YouTube)](https://www.youtube.com/watch?v=-48l3fPLbbo)  
- 📚 [Course Page – Game Development & Design](https://courses.cs.ut.ee/2025/gamedev/fall/Main/Lab5) 
- 📝 [Task List – CGLearn](https://cglearn.eu/student/tasks)
