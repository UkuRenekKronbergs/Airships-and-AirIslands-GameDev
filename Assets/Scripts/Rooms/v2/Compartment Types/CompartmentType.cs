...

{
    ...
    public string Name;
    //public Sprite Icon;
    public int MaxAmmount = 1; //How many compartments of this type are allowed per one ship.
    public int MinAmmount = 0;
    public int Health = 1;
    public int Cost = 1;
    public int MaxTier = 3; //How many compartments of the same type next to eachother can combine into 1 mega compartment.
